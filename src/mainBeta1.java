...
do {
	...
	public static void addContact() {
		...
		String name = a.nextLine()+a.nextLine();
		tmp.setContactName(name);
	...
	public static void deleteContact() {
		System.out.print("Enter the contact's name: ");
		pb.deleteContact(a.nextLine()+a.nextLine());
	}
	...
	public static void scheduleEvent() {
		...
		pb.scheduleEvent(e1, tmp);}
			...
			System.out.print("Enter contact name seprate by comma: ");
			 String tmp = a.nextLine();
